---
name: humanizer
description: Humanize text by removing AI-like patterns and matching a natural writing voice. Use when the user asks to 润色, 去AI味, 人性化, match a writing style, or make a draft sound more natural.
---

# Humanizer: Remove AI Writing Patterns

Upstream Hermes Agent skill, retained under its MIT license; see `LICENSE` in this Skill directory and `THIRD_PARTY_NOTICES.md`.
