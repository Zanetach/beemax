...
async function proactiveReversibleActionProbe() {
	...
	const toolPolicy = { risk: "low", sideEffect: "external", approval: "never", reversible: true, timeoutMs: 1_000, maxAttempts: 1, maxResultBytes: 10_000, impact: "Bounded evaluated mutation", effectProofProvider: "evaluation-provider" };
