export const capabilityInventory = Object.freeze([
	...
	{ kind: "skill", name: "procedure-conformance-check", description: "Apply an organization-supplied procedure to verify an arbitrary artifact and preserve evidence", aliases: ["按自定义流程核验"], triggers: ["流程核验"], version: "sha256:0558f341417a17600924c6796b16a8899f795b20509774696ba80a44503d3197", activeTools: ["skill_activate", "skill_read"], signals: { inputModalities: ["text", "file"], outputModalities: ["structured"], freshness: "unknown", evidence: "verified", effect: "none", health: "ready", relativeCost: 0.3, expectedLatencyMs: 900 } },
]);
