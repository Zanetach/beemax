export const capabilityInventory = Object.freeze([
	{ kind: "tool", name: "web_search", description: "Search current public sources and verify external evidence", aliases: ["联网检索", "公开证据"], triggers: ["research current sources"], exclude: ["不要联网", "do not search online"], version: "eval:1", activeTools: ["web_search"] },
	{ kind: "mcp", name: "meeting_schedule", description: "Schedule a meeting with participants", aliases: ["安排会议", "book time"], version: "eval:1", activeTools: ["mcp_meeting_schedule"] },
	{ kind: "tool", name: "memory_recall", description: "Recall confirmed prior decisions and preferences", aliases: ["回忆约定", "之前决定"], version: "eval:1", activeTools: ["memory_recall"] },
	{ kind: "tool", name: "file_read", description: "Read attached or local files", aliases: ["读取文件", "附件内容"], version: "eval:1", activeTools: ["read"] },
	{ kind: "tool", name: "data_analyze", description: "Analyze structured data, anomalies, and metrics", aliases: ["分析数据", "指标异常"], version: "eval:1", activeTools: ["data_analyze"] },
]);
