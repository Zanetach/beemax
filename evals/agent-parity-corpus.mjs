...
const scenarios = [
	...
	scenario({ id: "constraint-negation-zh", category: "semantics", prompt: "当前目标是在回复中完成一份简短的 Capability Routing 报告，内容说明能力如何选择合适 Tool。不要取消，直接继续完成报告；不要改目标。", facets: ["continuation", "negation"], outputContract: { requiredAnyGroups: [["报告", "report"], ["继续", "完成", "continue", "complete"]], forbidden: ["已取消", "cancelled"] } }),
