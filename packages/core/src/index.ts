...
export { FileCredentialVault, type CredentialInput, type CredentialMetadata, type CredentialVault, type CredentialVaultAuditEvent, type CredentialVaultAuditSink } from "./credential-vault.ts";
