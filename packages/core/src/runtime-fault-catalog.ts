...
export const RUNTIME_FAULT_CATALOG: readonly RuntimeFaultDefinition[] = [
	{
		...
		operatorRecovery: ["Inspect /tasks show <plan-id> and beemax trace show <execution-id>.", "Use /tasks retry <plan-id> only after unresolved Effects are reconciled."],
	...
	},
	{
		...
		operatorRecovery: ["Run beemax effect list --status unknown.", "Observe the external system, then run beemax effect reconcile <id> --status committed|failed."],
	...
	},
	{
		...
		operatorRecovery: ["Run beemax gateway status and beemax gateway logs.", "Inspect /tasks plans and unknown Effects."],
	...
	},
	{
		...
		operatorRecovery: ["Run beemax status --deep and /status.", "Inspect failed Plans before an explicit retry."],
	...
	},
	{
		...
		operatorRecovery: ["Run beemax effect list --status unknown.", "Reconcile from externally observed evidence; never infer success from model text."],
	...
	},
	{
		...
		operatorRecovery: ["Inspect /tasks show <plan-id> and beemax trace show <execution-id>.", "Use /resume <session-id> if the conversation session also changed."],
