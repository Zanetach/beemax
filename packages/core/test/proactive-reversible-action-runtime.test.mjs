...
const capability = { name: "external_update", policy: { risk: "low", sideEffect: "external", reversible: true, timeoutMs: 1_000, maxAttempts: 1, maxResultBytes: 10_000, impact: "Updates one reversible resource", effectProofProvider: "provider-a" }, compensation: proof };
