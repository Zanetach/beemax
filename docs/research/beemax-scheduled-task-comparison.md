...
- Chat tools support create/get/list/update/pause/resume/run-now/delete/history/status; mutations execute directly after the normal Governance and Effect gates: [`packages/core/src/automation-tools.ts`](../../packages/core/src/automation-tools.ts).
