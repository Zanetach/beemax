...
export function recordGatewayEvent(agentDir: string, event: "started" | "stopped" | "failed" | "approval" | "proactive_investigation" | "autonomy_blocked" | "context_compaction" | "capability_cognition" | "capability_cognition_fallback" | "group_observation_recorded" | "delivery_settled" | "profile_health_changed" | "memory_learning_maintenance", fields: Record<string, unknown> = {}): void {
