...
```bash
curl -fsSL https://raw.githubusercontent.com/Zanetach/beemax/v0.1.0-preview.10/scripts/bootstrap-install.sh | bash
...
set `BEEMAX_VERSION`, for example `curl -fsSL https://raw.githubusercontent.com/Zanetach/beemax/v0.1.0-preview.10/scripts/bootstrap-install.sh | BEEMAX_VERSION=v0.1.0-preview.10 bash`.
